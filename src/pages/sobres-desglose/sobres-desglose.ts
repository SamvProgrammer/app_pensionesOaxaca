...
export class SobresDesglosePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,private sobresPrd:SobresProvider,
    ...
    cargando.present();
    this.sobresPrd.getdesglosesobre(this.sobre.numjpp,this.sobre.archivo,this.tipo_nomina).subscribe(datos =>{
      cargando.dismiss();
  ...
  public imprimir(){
    ...
    let url = `https://docs.google.com/viewer?url=${ip}/empleados/${this.sobre.numjpp}/sobres/${this.sobre.archivo}/tiponomina/${this.tipo_nomina}/visualizar`;
